...
# [02] 2023 - Untitled - Contenu Extrait / Extracted Content

> [!cite] Citation
> Zotero citekey: `@unknown`
> Import this in Overleaf with: `\citep{unknown}`

**Source**: `literature/pdfs/[02] 2023 - Untitled.pdf`
**Date d'Extraction**: 2025-10-07
**Outil**: MinerU v2.5.4 (LLM-assisted formula + RapidTable extraction)
**Chapitre**: Pharmacology & QSAR

**Extraction Metrics**:
- ⚗️ Formulas: 0 (Quality: none)
- 📊 Tables: 0
0
- 🧪 Chemistry: Yes #smiles #alkaloids
